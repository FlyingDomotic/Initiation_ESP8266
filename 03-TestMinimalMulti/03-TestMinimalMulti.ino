 ...
 *
 *      Allume la LED quand le bouton est poussé (version NodeMCU ou D1 mini)
 *
 *  Matériel
...
#define NODE_MCU                                            // ESP8266 version NODE MCU (sinon, version D1 Mini)
    ...
    #define BOUTON_MODE INPUT_PULLUP                        // Mode de la pinoche du bouton (qui n'a pas de résistance de  tirage)
#endif
...
void loop() {
    ...
    if (digitalRead(PINOCHE_BOUTON) == BOUTON_POUSSE) {     // Si le bouton est pressé
